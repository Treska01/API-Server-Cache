...
export default class Response {
  ...
  /////////////////////////////////////////////// 200 ///////////////////////////////////////////////////////
    ...
    // Modifier la méthode
    // HttpContext.response.JSON(jsonObj, ETag="", fromCache = false ).
    // Si le paramètre fromCache est faux ajouter dans la cache
    // si la requête est de type API et que le id est non défini.
    JSON(jsonObj, ETag = "", fromCache = false) {   // ok status with content
        ...
        if (jsonObj != null) {
            if(!fromCache && this.HttpContext.path.isAPI
                 && typeof this.HttpContext.path.id === "undefined")
